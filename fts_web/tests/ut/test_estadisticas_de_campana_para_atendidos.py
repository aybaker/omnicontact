...
class EstadisticasParaReporteAtendido(FTSenderBaseTest):
    ...
    def test_obtener_total_atendido_por_evento_un_intento(self):
        ...
        self._insertar_evento(self.campana, 5, EventoDeContacto.EVENTO_CONTACTO_PROGRAMADO)
        self._insertar_evento(self.campana, 6, EventoDeContacto.EVENTO_CONTACTO_PROGRAMADO)
        ...
        self._insertar_evento(self.campana, 5, EventoDeContacto.EVENTO_DAEMON_INICIA_INTENTO, 1)
        self._insertar_evento(self.campana, 6, EventoDeContacto.EVENTO_DAEMON_INICIA_INTENTO, 1)
        ...
        self._insertar_evento(self.campana, 5, EventoDeContacto.EVENTO_DAEMON_ORIGINATE_SUCCESSFUL, 1)
        self._insertar_evento(self.campana, 6, EventoDeContacto.EVENTO_DAEMON_ORIGINATE_SUCCESSFUL, 1)
        ...
        self._insertar_evento(self.campana, 5, EventoDeContacto.EVENTO_ASTERISK_DIALPLAN_LOCAL_CHANNEL_INICIADO, 1)
        self._insertar_evento(self.campana, 6, EventoDeContacto.EVENTO_ASTERISK_DIALPLAN_LOCAL_CHANNEL_INICIADO, 1)
        ...
        self._insertar_evento(self.campana, 5, EventoDeContacto.EVENTO_ASTERISK_DIALPLAN_CAMPANA_INICIADO, 1)
        self._insertar_evento(self.campana, 5, EventoDeContacto.EVENTO_ASTERISK_AMD_MACHINE_DETECTED, 1)
        self._insertar_evento(self.campana, 6, EventoDeContacto.EVENTO_ASTERISK_DIALPLAN_CAMPANA_INICIADO, 1)
        self._insertar_evento(self.campana, 6, EventoDeContacto.EVENTO_ASTERISK_AMD_HUMAN_DETECTED, 1)
        self._insertar_evento(self.campana, 6, EventoDeContacto.EVENTO_ASTERISK_OPCION_2, 1)
        ...
        counter_por_evento = estadisticas_para_reporte_atendido.\
            _obtener_total_atendidos_por_evento(listado)
    ...
    def test_obtener_total_atendido_por_evento_dos_intento(self):
        ...
        self._insertar_evento(self.campana, 2, EventoDeContacto.EVENTO_ASTERISK_DIALSTATUS_CONGESTION, 1)
        self._insertar_evento(self.campana, 4, EventoDeContacto.EVENTO_ASTERISK_DIALSTATUS_NOANSWER, 1)
        self._insertar_evento(self.campana, 5, EventoDeContacto.EVENTO_ASTERISK_DIALSTATUS_BUSY, 1)
        self._insertar_evento(self.campana, 6, EventoDeContacto.EVENTO_ASTERISK_DIALSTATUS_CHANUNAVAIL, 1)
        ...
        self._insertar_evento(self.campana, 5, EventoDeContacto.EVENTO_DAEMON_INICIA_INTENTO, 2)
        self._insertar_evento(self.campana, 6, EventoDeContacto.EVENTO_DAEMON_INICIA_INTENTO, 2)
        ...
        self._insertar_evento(self.campana, 5, EventoDeContacto.EVENTO_DAEMON_ORIGINATE_SUCCESSFUL, 2)
        self._insertar_evento(self.campana, 6, EventoDeContacto.EVENTO_DAEMON_ORIGINATE_SUCCESSFUL, 2)
        ...
        self._insertar_evento(self.campana, 5, EventoDeContacto.EVENTO_ASTERISK_DIALPLAN_LOCAL_CHANNEL_INICIADO, 2)
        self._insertar_evento(self.campana, 6, EventoDeContacto.EVENTO_ASTERISK_DIALPLAN_LOCAL_CHANNEL_INICIADO, 2)

        # atendieron
        self._insertar_evento(self.campana, 4, EventoDeContacto.EVENTO_ASTERISK_DIALPLAN_CAMPANA_INICIADO, 2)
        self._insertar_evento(self.campana, 4, EventoDeContacto.EVENTO_ASTERISK_AMD_MACHINE_DETECTED, 2)
        self._insertar_evento(self.campana, 5, EventoDeContacto.EVENTO_ASTERISK_DIALPLAN_CAMPANA_INICIADO, 2)
        self._insertar_evento(self.campana, 5, EventoDeContacto.EVENTO_ASTERISK_AMD_MACHINE_DETECTED, 2)
        self._insertar_evento(self.campana, 6, EventoDeContacto.EVENTO_ASTERISK_DIALPLAN_CAMPANA_INICIADO, 2)
        self._insertar_evento(self.campana, 6, EventoDeContacto.EVENTO_ASTERISK_AMD_MACHINE_DETECTED, 2)
