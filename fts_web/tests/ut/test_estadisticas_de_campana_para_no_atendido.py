...
class EstadisticasParaReporteNoAtendido(FTSenderBaseTest):
    ...
    def test_obtener_total_no_atendido_por_evento_dos_intento_no_answer(self):
        ...
        # atendieron
        self._insertar_evento(campana, 4, EventoDeContacto.EVENTO_ASTERISK_DIALPLAN_CAMPANA_INICIADO, 1)
        self._insertar_evento(campana, 4, EventoDeContacto.EVENTO_ASTERISK_AMD_HUMAN_DETECTED, 1)
        self._insertar_evento(campana, 4, EventoDeContacto.EVENTO_ASTERISK_OPCION_1, 1)

        # no atendieron
        self._insertar_evento(campana, 1, EventoDeContacto.EVENTO_ASTERISK_DIALSTATUS_NOANSWER, 1)
        self._insertar_evento(campana, 2, EventoDeContacto.EVENTO_ASTERISK_DIALSTATUS_NOANSWER, 1)
        self._insertar_evento(campana, 3, EventoDeContacto.EVENTO_ASTERISK_DIALSTATUS_NOANSWER, 1)

        # inicia intento 2
        self._insertar_evento(campana, 1, EventoDeContacto.EVENTO_DAEMON_INICIA_INTENTO, 2)
        self._insertar_evento(campana, 2, EventoDeContacto.EVENTO_DAEMON_INICIA_INTENTO, 2)
        self._insertar_evento(campana, 3, EventoDeContacto.EVENTO_DAEMON_INICIA_INTENTO, 2)

        # originate exitoso
        self._insertar_evento(campana, 1, EventoDeContacto.EVENTO_DAEMON_ORIGINATE_SUCCESSFUL, 2)
        self._insertar_evento(campana, 2, EventoDeContacto.EVENTO_DAEMON_ORIGINATE_SUCCESSFUL, 2)
        self._insertar_evento(campana, 3, EventoDeContacto.EVENTO_DAEMON_ORIGINATE_SUCCESSFUL, 2)

        # canal local iniciado        
        self._insertar_evento(campana, 1, EventoDeContacto.EVENTO_ASTERISK_DIALPLAN_LOCAL_CHANNEL_INICIADO, 2)
        self._insertar_evento(campana, 2, EventoDeContacto.EVENTO_ASTERISK_DIALPLAN_LOCAL_CHANNEL_INICIADO, 2)
        self._insertar_evento(campana, 3, EventoDeContacto.EVENTO_ASTERISK_DIALPLAN_LOCAL_CHANNEL_INICIADO, 2)

        # atendieron
        self._insertar_evento(campana, 3, EventoDeContacto.EVENTO_ASTERISK_DIALPLAN_CAMPANA_INICIADO, 2)
        self._insertar_evento(campana, 3, EventoDeContacto.EVENTO_ASTERISK_AMD_HUMAN_DETECTED, 2)
        self._insertar_evento(campana, 3, EventoDeContacto.EVENTO_ASTERISK_OPCION_2, 2)

        # no atendieron
        self._insertar_evento(campana, 2, EventoDeContacto.EVENTO_ASTERISK_DIALSTATUS_NOANSWER, 2)
        self._insertar_evento(campana, 2, EventoDeContacto.EVENTO_ASTERISK_DIALSTATUS_CONGESTION, 2)
    ...
    def test_obtener_total_no_atendido_por_evento_dos_intento_failed(self):
        ...
        # no atendieron
        self._insertar_evento(campana, 1, EventoDeContacto.EVENTO_ASTERISK_DIALSTATUS_CHANUNAVAIL, 1)
        self._insertar_evento(campana, 2, EventoDeContacto.EVENTO_ASTERISK_DIALSTATUS_CONGESTION, 1)
        self._insertar_evento(campana, 3, EventoDeContacto.EVENTO_ASTERISK_DIALSTATUS_CHANUNAVAIL, 1)
        ...
        # no atendieron
        self._insertar_evento(campana, 2, EventoDeContacto.EVENTO_ASTERISK_DIALSTATUS_CHANUNAVAIL, 2)
        self._insertar_evento(campana, 2, EventoDeContacto.EVENTO_ASTERISK_DIALSTATUS_CONGESTION, 2)
