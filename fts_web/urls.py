...
urlpatterns = patterns('',
    ...
    url(r'^template/(?P<pk_campana>\d+)/audio/$',
    ...
    url(r'^template/opcion/(?P<pk_campana>\d+)/elimina/$',
    ...
    url(r'^campana/(?P<pk_campana>\d+)/audio/$',
    ...
    url(r'^campana/opcion/(?P<pk_campana>\d+)/elimina/$',
