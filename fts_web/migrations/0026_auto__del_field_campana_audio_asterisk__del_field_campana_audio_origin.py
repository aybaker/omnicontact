...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campana.audio_asterisk'
        db.delete_column(u'fts_web_campana', 'audio_asterisk')

        # Deleting field 'Campana.audio_original'
        db.delete_column(u'fts_web_campana', 'audio_original')


    def backwards(self, orm):
        # Adding field 'Campana.audio_asterisk'
        db.add_column(u'fts_web_campana', 'audio_asterisk',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Campana.audio_original'
        db.add_column(u'fts_web_campana', 'audio_original',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)
