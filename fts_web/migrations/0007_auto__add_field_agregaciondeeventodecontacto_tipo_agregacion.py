...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AgregacionDeEventoDeContacto.tipo_agregacion'
        db.add_column(u'fts_web_agregaciondeeventodecontacto', 'tipo_agregacion',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AgregacionDeEventoDeContacto.tipo_agregacion'
        db.delete_column(u'fts_web_agregaciondeeventodecontacto', 'tipo_agregacion')
    ...
    models = {
        ...
        u'fts_web.agregaciondeeventodecontacto': {
            ...
            'tipo_agregacion': ('django.db.models.fields.IntegerField', [], {})
        },
