...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'fts_web_contacto', 'telefono', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'Contacto.telefono'
        db.alter_column(u'fts_web_contacto', 'telefono', self.gf('django.db.models.fields.PositiveIntegerField')())
