...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'fts_web_agregaciondeeventodecontacto', 'timestamp_ultimo_evento', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'AgregacionDeEventoDeContacto.timestamp_ultimo_evento'
        db.alter_column(u'fts_web_agregaciondeeventodecontacto', 'timestamp_ultimo_evento', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        u'fts_web.agregaciondeeventodecontacto': {
            ...
            'timestamp_ultimo_evento': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
