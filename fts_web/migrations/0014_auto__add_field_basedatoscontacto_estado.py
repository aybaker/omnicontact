...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseDatosContacto.estado'
        db.add_column(u'fts_web_basedatoscontacto', 'estado',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseDatosContacto.estado'
        db.delete_column(u'fts_web_basedatoscontacto', 'estado')
