...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DerivacionExterna'
        db.create_table(u'fts_web_derivacionexterna', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('dial_string', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('borrado', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'fts_web', ['DerivacionExterna'])


    def backwards(self, orm):
        # Deleting model 'DerivacionExterna'
        db.delete_table(u'fts_web_derivacionexterna')
