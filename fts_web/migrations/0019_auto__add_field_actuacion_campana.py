...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Actuacion.campana'
        db.add_column(u'fts_web_actuacion', 'campana',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name=u'actuaciones', to=orm['fts_web.Campana']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Actuacion.campana'
        db.delete_column(u'fts_web_actuacion', 'campana_id')
