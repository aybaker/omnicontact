...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campana.cantidad_canales'
        db.add_column(u'fts_web_campana', 'cantidad_canales',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Campana.cantidad_intentos'
        db.add_column(u'fts_web_campana', 'cantidad_intentos',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Campana.segundos_ring'
        db.add_column(u'fts_web_campana', 'segundos_ring',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


        # Changing field 'Campana.fecha_fin'
        db.alter_column(u'fts_web_campana', 'fecha_fin', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Campana.fecha_inicio'
        db.alter_column(u'fts_web_campana', 'fecha_inicio', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'Campana.cantidad_canales'
        db.delete_column(u'fts_web_campana', 'cantidad_canales')

        # Deleting field 'Campana.cantidad_intentos'
        db.delete_column(u'fts_web_campana', 'cantidad_intentos')

        # Deleting field 'Campana.segundos_ring'
        db.delete_column(u'fts_web_campana', 'segundos_ring')


        # Changing field 'Campana.fecha_fin'
        db.alter_column(u'fts_web_campana', 'fecha_fin', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Campana.fecha_inicio'
        db.alter_column(u'fts_web_campana', 'fecha_inicio', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
