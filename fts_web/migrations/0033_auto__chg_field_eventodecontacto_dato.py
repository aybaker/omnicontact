...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'fts_web_eventodecontacto', 'dato', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EventoDeContacto.dato'
        raise RuntimeError("Cannot reverse this migration. 'EventoDeContacto.dato' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'EventoDeContacto.dato'
        db.alter_column(u'fts_web_eventodecontacto', 'dato', self.gf('django.db.models.fields.SmallIntegerField')())
