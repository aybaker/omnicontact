...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'fts_web_campana', 'fecha_fin', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Campana.fecha_inicio'
        db.alter_column(u'fts_web_campana', 'fecha_inicio', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'fts_web.campana': {
            ...
            'audio_asterisk': ('django.db.models.fields.files.FileField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
