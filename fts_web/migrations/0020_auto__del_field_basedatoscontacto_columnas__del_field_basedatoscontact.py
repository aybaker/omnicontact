...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BaseDatosContacto.columnas'
        db.delete_column(u'fts_web_basedatoscontacto', 'columnas')
    ...
    def backwards(self, orm):
        # Adding field 'BaseDatosContacto.columnas'
        db.add_column(u'fts_web_basedatoscontacto', 'columnas',
