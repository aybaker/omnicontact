...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DuracionDeLlamada.numero_telefono'
        db.alter_column(u'fts_web_duraciondellamada', 'numero_telefono', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'DuracionDeLlamada.numero_telefono'
        db.alter_column(u'fts_web_duraciondellamada', 'numero_telefono', self.gf('django.db.models.fields.CharField')(max_length=13))
