...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OpcionSms'
        db.create_table(u'fts_web_opcionsms', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('respuesta', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('campana_sms', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'opcionsmss', to=orm['fts_web.CampanaSms'])),
        ))
        db.send_create_signal(u'fts_web', ['OpcionSms'])


    def backwards(self, orm):
        # Deleting model 'OpcionSms'
        db.delete_table(u'fts_web_opcionsms')
