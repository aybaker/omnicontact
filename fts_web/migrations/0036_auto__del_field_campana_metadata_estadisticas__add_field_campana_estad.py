...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Campana.metadata_estadisticas'
        db.delete_column(u'fts_web_campana', 'metadata_estadisticas')

        # Adding field 'Campana.estadisticas'
        db.add_column(u'fts_web_campana', 'estadisticas',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Campana.metadata_estadisticas'
        db.add_column(u'fts_web_campana', 'metadata_estadisticas',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Campana.estadisticas'
        db.delete_column(u'fts_web_campana', 'estadisticas')
