...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Opcion.calificacion'
        db.add_column(u'fts_web_opcion', 'calificacion',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fts_web.Calificacion'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Opcion.calificacion'
        db.delete_column(u'fts_web_opcion', 'calificacion_id')
