...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contacto.datos'
        db.alter_column(u'fts_web_contacto', 'datos', self.gf('django.db.models.fields.TextField')(default=''))

    def backwards(self, orm):

        # Changing field 'Contacto.datos'
        db.alter_column(u'fts_web_contacto', 'datos', self.gf('django.db.models.fields.TextField')(null=True))
