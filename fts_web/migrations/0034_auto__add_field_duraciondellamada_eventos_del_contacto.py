...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DuracionDeLlamada.eventos_del_contacto'
        db.add_column(u'fts_web_duraciondellamada', 'eventos_del_contacto',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DuracionDeLlamada.eventos_del_contacto'
        db.delete_column(u'fts_web_duraciondellamada', 'eventos_del_contacto')
