...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AgregacionDeEventoDeContacto'
        db.create_table(u'fts_web_agregaciondeeventodecontacto', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('campana_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('numero_intento', self.gf('django.db.models.fields.IntegerField')()),
            ('cantidad_intentos', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('cantidad_finalizados', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('cantidad_opcion_0', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('cantidad_opcion_1', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('cantidad_opcion_2', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('cantidad_opcion_3', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('cantidad_opcion_4', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('cantidad_opcion_5', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('cantidad_opcion_6', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('cantidad_opcion_7', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('cantidad_opcion_8', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('cantidad_opcion_9', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('timestamp_ultima_actualizacion', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'fts_web', ['AgregacionDeEventoDeContacto'])


    def backwards(self, orm):
        # Deleting model 'AgregacionDeEventoDeContacto'
        db.delete_table(u'fts_web_agregaciondeeventodecontacto')
    ...
    models = {
        ...
        u'fts_web.agregaciondeeventodecontacto': {
            ...
            'cantidad_finalizados': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'cantidad_intentos': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'cantidad_opcion_0': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'cantidad_opcion_1': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'cantidad_opcion_2': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'cantidad_opcion_3': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'cantidad_opcion_4': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'cantidad_opcion_5': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'cantidad_opcion_6': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'cantidad_opcion_7': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'cantidad_opcion_8': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'cantidad_opcion_9': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
