...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'fts_web_agentegrupoatencion', 'numero_interno', self.gf('django.db.models.fields.CharField')(max_length=32))

    def backwards(self, orm):

        # Changing field 'AgenteGrupoAtencion.numero_interno'
        db.alter_column(u'fts_web_agentegrupoatencion', 'numero_interno', self.gf('django.db.models.fields.PositiveIntegerField')())
