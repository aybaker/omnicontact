...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OpcionSms.respuesta_descripcion'
        db.add_column(u'fts_web_opcionsms', 'respuesta_descripcion',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OpcionSms.respuesta_descripcion'
        db.delete_column(u'fts_web_opcionsms', 'respuesta_descripcion')
