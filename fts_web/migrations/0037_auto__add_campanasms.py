...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CampanaSms'
        db.create_table(u'fts_web_campanasms', (
            ...
            ('fecha_fin', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('bd_contacto', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'campanasmss', null=True, to=orm['fts_web.BaseDatosContacto'])),
            ('cantidad_chips', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('template_mensaje', self.gf('django.db.models.fields.TextField')()),
            ('tiene_respuesta', self.gf('django.db.models.fields.BooleanField')()),
            ('identificador_campana_sms', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'fts_web', ['CampanaSms'])


    def backwards(self, orm):
        # Deleting model 'CampanaSms'
        db.delete_table(u'fts_web_campanasms')
    ...
    models = {
        ...
        u'fts_web.campanasms': {
            ...
            'fecha_inicio': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'identificador_campana_sms': ('django.db.models.fields.PositiveIntegerField', [], {}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
