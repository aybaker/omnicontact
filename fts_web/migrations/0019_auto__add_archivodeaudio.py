...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ArchivoDeAudio'
        db.create_table(u'fts_web_archivodeaudio', (
        ...
        db.send_create_signal(u'fts_web', ['ArchivoDeAudio'])


    def backwards(self, orm):
        # Deleting model 'ArchivoDeAudio'
        db.delete_table(u'fts_web_archivodeaudio')
