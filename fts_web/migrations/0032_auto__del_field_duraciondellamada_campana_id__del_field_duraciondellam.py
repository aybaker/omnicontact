...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DuracionDeLlamada.campana_id'
        db.delete_column(u'fts_web_duraciondellamada', 'campana_id')

        # Deleting field 'DuracionDeLlamada.numero_telefonico_contacto'
        db.delete_column(u'fts_web_duraciondellamada', 'numero_telefonico_contacto')

        # Adding field 'DuracionDeLlamada.campana'
        db.add_column(u'fts_web_duraciondellamada', 'campana',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['fts_web.Campana']),
                      keep_default=False)

        # Adding field 'DuracionDeLlamada.numero_telefono'
        db.add_column(u'fts_web_duraciondellamada', 'numero_telefono',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=13),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DuracionDeLlamada.campana_id'
        db.add_column(u'fts_web_duraciondellamada', 'campana_id',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'DuracionDeLlamada.numero_telefonico_contacto'
        db.add_column(u'fts_web_duraciondellamada', 'numero_telefonico_contacto',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1, db_index=True),
                      keep_default=False)

        # Deleting field 'DuracionDeLlamada.campana'
        db.delete_column(u'fts_web_duraciondellamada', 'campana_id')

        # Deleting field 'DuracionDeLlamada.numero_telefono'
        db.delete_column(u'fts_web_duraciondellamada', 'numero_telefono')
    ...
    models = {
        ...
        u'fts_web.duraciondellamada': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'numero_telefono': ('django.db.models.fields.CharField', [], {'max_length': '13'})
        },
