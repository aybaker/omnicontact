...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CampanaSms.template_mensaje_opcional'
        db.add_column(u'fts_web_campanasms', 'template_mensaje_opcional',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CampanaSms.template_mensaje_alternativo'
        db.add_column(u'fts_web_campanasms', 'template_mensaje_alternativo',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'CampanaSms.template_mensaje'
        db.alter_column(u'fts_web_campanasms', 'template_mensaje', self.gf('django.db.models.fields.TextField')(default='hola como estas'))

    def backwards(self, orm):
        # Deleting field 'CampanaSms.template_mensaje_opcional'
        db.delete_column(u'fts_web_campanasms', 'template_mensaje_opcional')

        # Deleting field 'CampanaSms.template_mensaje_alternativo'
        db.delete_column(u'fts_web_campanasms', 'template_mensaje_alternativo')


        # Changing field 'CampanaSms.template_mensaje'
        db.alter_column(u'fts_web_campanasms', 'template_mensaje', self.gf('django.db.models.fields.TextField')(null=True))
