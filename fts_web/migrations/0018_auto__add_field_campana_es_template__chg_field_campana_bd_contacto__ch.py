...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campana.es_template'
        db.add_column(u'fts_web_campana', 'es_template',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Campana.bd_contacto'
        db.alter_column(u'fts_web_campana', 'bd_contacto_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['fts_web.BaseDatosContacto']))

        # Changing field 'Campana.fecha_fin'
        db.alter_column(u'fts_web_campana', 'fecha_fin', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Campana.fecha_inicio'
        db.alter_column(u'fts_web_campana', 'fecha_inicio', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Campana.es_template'
        db.delete_column(u'fts_web_campana', 'es_template')


        # Changing field 'Campana.bd_contacto'
        db.alter_column(u'fts_web_campana', 'bd_contacto_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['fts_web.BaseDatosContacto']))

        # Changing field 'Campana.fecha_fin'
        db.alter_column(u'fts_web_campana', 'fecha_fin', self.gf('django.db.models.fields.DateField')(default=1))

        # Changing field 'Campana.fecha_inicio'
        db.alter_column(u'fts_web_campana', 'fecha_inicio', self.gf('django.db.models.fields.DateField')(default=1))
