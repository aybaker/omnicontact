...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActuacionSms'
        db.create_table(u'fts_web_actuacionsms', (
            ...
            ('campana_sms', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'actuaciones', to=orm['fts_web.CampanaSms'])),
        ))
        db.send_create_signal(u'fts_web', ['ActuacionSms'])


    def backwards(self, orm):
        # Deleting model 'ActuacionSms'
        db.delete_table(u'fts_web_actuacionsms')
