...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AgregacionDeEventoDeContacto.timestamp_ultimo_evento'
        db.alter_column(u'fts_web_agregaciondeeventodecontacto', 'timestamp_ultimo_evento', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'AgregacionDeEventoDeContacto.timestamp_ultimo_evento'
        db.alter_column(u'fts_web_agregaciondeeventodecontacto', 'timestamp_ultimo_evento', self.gf('django.db.models.fields.DateTimeField')(default=1))
