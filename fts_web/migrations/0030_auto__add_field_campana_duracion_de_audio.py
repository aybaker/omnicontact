...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campana.duracion_de_audio'
        db.add_column(u'fts_web_campana', 'duracion_de_audio',
                      self.gf('django.db.models.fields.TimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campana.duracion_de_audio'
        db.delete_column(u'fts_web_campana', 'duracion_de_audio')
