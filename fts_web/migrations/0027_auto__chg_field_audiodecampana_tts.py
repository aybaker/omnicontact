...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AudioDeCampana.tts'
        db.alter_column(u'fts_web_audiodecampana', 'tts', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'AudioDeCampana.tts'
        db.alter_column(u'fts_web_audiodecampana', 'tts', self.gf('django.db.models.fields.CharField')(default=1, max_length=128))
