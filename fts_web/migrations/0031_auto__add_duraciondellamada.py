...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DuracionDeLlamada'
        db.create_table(u'fts_web_duraciondellamada', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('campana_id', self.gf('django.db.models.fields.IntegerField')()),
            ('numero_telefonico_contacto', self.gf('django.db.models.fields.PositiveIntegerField')(db_index=True)),
            ('fecha_hora_llamada', self.gf('django.db.models.fields.DateTimeField')()),
            ('duracion_en_segundos', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'fts_web', ['DuracionDeLlamada'])


    def backwards(self, orm):
        # Deleting model 'DuracionDeLlamada'
        db.delete_table(u'fts_web_duraciondellamada')
    ...
    models = {
        ...
        u'fts_web.duraciondellamada': {
            ...
            'campana_id': ('django.db.models.fields.IntegerField', [], {}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'numero_telefonico_contacto': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'})
        },
