...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campana.accion_contestador'
        db.add_column(u'fts_web_campana', 'accion_contestador',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campana.accion_contestador'
        db.delete_column(u'fts_web_campana', 'accion_contestador')
