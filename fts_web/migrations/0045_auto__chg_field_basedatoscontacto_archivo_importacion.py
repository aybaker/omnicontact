...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseDatosContacto.archivo_importacion'
        db.alter_column(u'fts_web_basedatoscontacto', 'archivo_importacion', self.gf('django.db.models.fields.files.FileField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'BaseDatosContacto.archivo_importacion'
        db.alter_column(u'fts_web_basedatoscontacto', 'archivo_importacion', self.gf('django.db.models.fields.files.FileField')(max_length=100))
