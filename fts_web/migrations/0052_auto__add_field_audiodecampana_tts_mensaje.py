...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AudioDeCampana.tts_mensaje'
        db.add_column(u'fts_web_audiodecampana', 'tts_mensaje',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AudioDeCampana.tts_mensaje'
        db.delete_column(u'fts_web_audiodecampana', 'tts_mensaje')
    ...
    models = {
        ...
        u'fts_web.audiodecampana': {
            ...
            'tts_mensaje': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
