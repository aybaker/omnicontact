...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fts_web_eventodecontacto', (
            ...
            ('dato', self.gf('django.db.models.fields.SmallIntegerField')()),
        ))
        db.send_create_signal(u'fts_web', ['EventoDeContacto'])


        # Changing field 'Campana.audio_asterisk'
        db.alter_column(u'fts_web_campana', 'audio_asterisk', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Campana.audio_asterisk'
        db.alter_column(u'fts_web_campana', 'audio_asterisk', self.gf('django.db.models.fields.files.FileField')(max_length=200, null=True))
    ...
    models = {
        ...
        u'fts_web.eventodecontacto': {
            ...
            'dato': ('django.db.models.fields.SmallIntegerField', [], {}),
