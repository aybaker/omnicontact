...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseDatosContacto.nombre_archivo_importacion'
        db.add_column(u'fts_web_basedatoscontacto', 'nombre_archivo_importacion',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=256),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseDatosContacto.nombre_archivo_importacion'
        db.delete_column(u'fts_web_basedatoscontacto', 'nombre_archivo_importacion')
