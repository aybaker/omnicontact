...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Opcion.derivacion_externa'
        db.add_column(u'fts_web_opcion', 'derivacion_externa',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fts_web.DerivacionExterna'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Opcion.derivacion_externa'
        db.delete_column(u'fts_web_opcion', 'derivacion_externa_id')
