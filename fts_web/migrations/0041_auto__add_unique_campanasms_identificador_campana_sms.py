...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CampanaSms', fields ['identificador_campana_sms']
        db.create_unique(u'fts_web_campanasms', ['identificador_campana_sms'])


    def backwards(self, orm):
        # Removing unique constraint on 'CampanaSms', fields ['identificador_campana_sms']
        db.delete_unique(u'fts_web_campanasms', ['identificador_campana_sms'])
