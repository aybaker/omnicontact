...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GrupoAtencion.borrado'
        db.add_column(u'fts_web_grupoatencion', 'borrado',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GrupoAtencion.borrado'
        db.delete_column(u'fts_web_grupoatencion', 'borrado')
