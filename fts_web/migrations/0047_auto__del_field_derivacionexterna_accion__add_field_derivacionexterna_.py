...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DerivacionExterna.accion'
        db.delete_column(u'fts_web_derivacionexterna', 'accion')

        # Adding field 'DerivacionExterna.tipo_derivacion'
        db.add_column(u'fts_web_derivacionexterna', 'tipo_derivacion',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DerivacionExterna.accion'
        db.add_column(u'fts_web_derivacionexterna', 'accion',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

        # Deleting field 'DerivacionExterna.tipo_derivacion'
        db.delete_column(u'fts_web_derivacionexterna', 'tipo_derivacion')
