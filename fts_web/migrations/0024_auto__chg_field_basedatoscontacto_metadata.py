...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BaseDatosContacto.metadata'
        db.alter_column(u'fts_web_basedatoscontacto', 'metadata', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'BaseDatosContacto.metadata'
        db.alter_column(u'fts_web_basedatoscontacto', 'metadata', self.gf('django.db.models.fields.TextField')(default=''))
