...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'AudioDeCampana', fields ['orden', 'campana']
        db.create_unique(u'fts_web_audiodecampana', ['orden', 'campana_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'AudioDeCampana', fields ['orden', 'campana']
        db.delete_unique(u'fts_web_audiodecampana', ['orden', 'campana_id'])
