...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AgregacionDeEventoDeContacto.tipo_agregacion'
        db.alter_column(u'fts_web_agregaciondeeventodecontacto', 'tipo_agregacion', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'AgregacionDeEventoDeContacto.tipo_agregacion'
        db.alter_column(u'fts_web_agregaciondeeventodecontacto', 'tipo_agregacion', self.gf('django.db.models.fields.IntegerField')(default=1))
