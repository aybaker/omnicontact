...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BaseDatosContacto.cantidad_contactos'
        db.add_column(u'fts_web_basedatoscontacto', 'cantidad_contactos',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BaseDatosContacto.cantidad_contactos'
        db.delete_column(u'fts_web_basedatoscontacto', 'cantidad_contactos')
