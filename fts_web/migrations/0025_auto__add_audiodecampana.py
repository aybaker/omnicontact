...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AudioDeCampana'
        db.create_table(u'fts_web_audiodecampana', (
            ...
            ('tts', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('archivo_de_audio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fts_web.ArchivoDeAudio'], null=True, blank=True)),
            ('campana', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fts_web.Campana'])),
        ))
        db.send_create_signal(u'fts_web', ['AudioDeCampana'])


    def backwards(self, orm):
        # Deleting model 'AudioDeCampana'
        db.delete_table(u'fts_web_audiodecampana')
    ...
    models = {
        ...
        u'fts_web.audiodecampana': {
            'Meta': {'object_name': 'AudioDeCampana'},
            ...
            'tts': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
