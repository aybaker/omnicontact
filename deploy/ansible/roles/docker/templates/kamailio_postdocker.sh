...
#!substdef "!PKEY_LOCATION!{{ kamailio_location }}/root/etc/certs/key.pem!g"
#!substdef "!CERT_LOCATION!{{ kamailio_location }}/root/etc/certs/cert.pem!g"
#!substdef "!CA_LOCATION!{{ kamailio_location }}/root/etc/certs/demoCA/cert.pem!g"
#!substdef "!SECRET_KEY!12345!g"
EOF
