...
class EliminarRutaSaliente(DeleteView):
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if ruta_saliente.campana_set.exists():
            message = ("No está permitido eliminar una Ruta Saliente asociado a una campaña")
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if ruta_entrante.destino.tipo == 1:
            if ruta_entrante.destino.content_object.outr:
                message = ("No está permitido eliminar una Ruta Saliente asociado"
                           "a una campaña con una Ruta Saliente.")
                messages.warning(self.request, message)
