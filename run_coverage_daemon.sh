...
coverage run --omit='fts_daemon/migrations/*,fts_daemon/management/*,fts_web/migrations/*,fts_web/tests/*,fts_web/sample_settings_local.py,fts_web/wsgi.py' --source='fts_daemon' manage.py test fts_tests fts_web fts_daemon
